...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        ...
        PeerAddress pa = new PeerAddress(BitcoinMainNetParams.get(),
    ...
    public void testBitcoinSerialize() throws Exception {
        PeerAddress pa = new PeerAddress(BitcoinMainNetParams.get(), InetAddress.getByName(null), 8333, 0, BigInteger.ZERO);
