...
import org.oceanj.utils.BtcAutoFormat.Style;
import static org.oceanj.utils.BtcAutoFormat.Style.*;
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link org.oceanj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
