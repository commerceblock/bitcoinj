...
import org.oceanj.crypto.LazyECPoint;
import org.oceanj.crypto.LinuxSecureRandom;
...
public class ECKey {
     ...
     * given any private key bytes to begin with.
     */
     ...
     * @throws org.oceanj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.oceanj.core.ECKey.ECDSASignature#toASN1()}
     ...
     * @throws org.oceanj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.oceanj.core.DumpedPrivateKey#toString()} method to get the string.
     *
