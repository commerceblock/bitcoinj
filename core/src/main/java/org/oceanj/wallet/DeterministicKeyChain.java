...
import org.oceanj.crypto.ChildNumber;
import org.oceanj.crypto.DeterministicHierarchy;
import org.oceanj.crypto.DeterministicKey;
import org.oceanj.crypto.HDKeyDerivation;
import org.oceanj.crypto.HDUtils;
import org.oceanj.script.Script;
import org.oceanj.utils.Threading;
 ...
 * {@link org.oceanj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.oceanj.crypto.MnemonicCode},
 ...
 * {@link org.oceanj.crypto.DeterministicKey#serializePubB58(org.oceanj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.oceanj.crypto.DeterministicKey#deserializeB58(org.oceanj.crypto.DeterministicKey, String, org.oceanj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.oceanj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.oceanj.crypto.DeterministicHierarchy} and
 * {@link org.oceanj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
//    }
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.oceanj.crypto.DeterministicKey)}
    ...
    public String toString(boolean includePrivateKeys, NetworkParameters params) {
        ...
        if (seed != null) {
            if (includePrivateKeys) {
                DeterministicSeed decryptedSeed = seed;
    ...
    protected void formatAddresses(NetworkParameters params,
