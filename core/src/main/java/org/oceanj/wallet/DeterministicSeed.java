...
public class DeterministicSeed {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link org.oceanj.crypto.MnemonicCode} for more
     ...
     *
     * @throws org.oceanj.crypto.MnemonicException if check fails
     */
